...
namespace WinForms3D {
    ...
    public static class MathUtils {
        ...
        internal static float ComputeNDotL(Vector3 vertexCenter, Vector3 normal, Vector3 lightPosition) => Math.Max(0, Vector3.Dot(normal, Vector3.Normalize(lightPosition - vertexCenter)));
